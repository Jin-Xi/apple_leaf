...
class BaseConfig():
    def __init__(self, modelName):
        ...
        # 各个存储路径名称
        self.img_train_pre = '../../AgriculturalDisease_trainingset/images/'
        self.img_val_pre = '../../AgriculturalDisease_validationset/images/'
        self.img_test_pre = '../../AgriculturalDisease_testA/images/'
        self.annotation_train = '../../AgriculturalDisease_trainingset/AgriculturalDisease_train_annotations.json'
        self.annotation_val = '../../AgriculturalDisease_validationset/AgriculturalDisease_validation_annotations.json'
